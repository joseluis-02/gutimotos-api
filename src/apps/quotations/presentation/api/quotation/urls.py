...
from .views import create_quotation, patch_quotation_status, update_quotation_items, list_quotation, get_quotation_items
app_name = 'quotation'
urlpatterns = [
    ...
    path('api/quotation/',                              list_quotation,     name='list_quotation'),
    path('api/quotation/<uuid:quotation_id>/items/',    get_quotation_items, name='quotation_items'),
]
